      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-6 md:px-12 py-12 md:py-16 text-center">
          ...
          <p className="text-lg md:text-xl mb-12 max-w-2xl mx-auto" style={{ color: 'var(--theme-text-soft)' }}>
            ...
            the Youth Forum (IYF) and BhaktiVriksha for families.
          </p>
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            ></div>
            <p className="text-gray-500 max-w-xl mx-auto">
              Spiritual growth for youth, families, and devotees at every stage of life
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-sm font-semibold text-yellow-100 mb-4">For Families & Senior Devotees</p>
              <p className="mb-8" style={{ color: 'var(--theme-text-soft)' }}>
