...
export default function CampusPreachingPage() {
  return (
    <div className="min-h-[calc(100vh-8rem)] bg-white py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-sm text-gray-500 mb-6 flex items-center gap-2">
          ...
          <span>›</span>
          <span className="font-medium text-gray-800">Campus Preaching</span>
        </div>
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Campus Preaching</h1>
        </div>
        
        <p className="text-gray-600 text-lg max-w-2xl mb-10 leading-relaxed">
          Seminars and programs in colleges and companies spreading Vedic knowledge across campuses.
        </p>
        ...
        <div className="rounded-3xl p-10 text-center text-white" style={{ background: 'linear-gradient(135deg, var(--theme-cta-from), var(--theme-cta-to))' }}>
          <h2 className="text-2xl font-bold mb-6">Bring wisdom to your campus</h2>
